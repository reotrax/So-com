...
import com.socom.so_com.fragment.TwitterFragment;
...
/*
 * Social Network Service Complex = so-com
 */
public class MainActivity extends AppCompatActivity
	...
	private void accountGet(Twitter twitter) {
		AsyncTask<Twitter, Void, Object> asyncTask = new AsyncTask<Twitter, Void, Object>() {
			@Override
			protected Object doInBackground(Twitter... twitter) {
				User user = null;
				try {

					user = twitter[0].verifyCredentials();
					//RequestToken requestToken = twitter.getOAuthRequestToken();

					// ツイートする
					//twitter4j.Status status = twitter[0].updateStatus("てす");
...
//				loader = new Async(this, twitter);
	...
	public void onLoadFinished(Loader loader, Object data) {
		getSupportLoaderManager().destroyLoader(loadNum);
	}
